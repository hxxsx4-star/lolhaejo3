...
async def generate_status_image(data, points, buffs, is_annoyed, is_diseased, current_idx, total_pets):
    ...
    # --- 3. EXP 바 ---
    draw.text((500, 292), "EXP", font=font_medium, fill=(255, 200, 100), stroke_width=1, stroke_fill="black")
    ...
    # --- 5. 하단 게이지 4종 ---
    # 1열
    draw.text((300, 407), "🍗 포만도", font=font_small, fill=(255, 255, 255), stroke_width=1, stroke_fill="black")
    draw_progress_bar(draw, 300, 432, 270, 15, data.get('fullness', 0), (50, 50, 50), (255, 100, 100))

    draw.text((580, 407), "😴 피로도", font=font_small, fill=(255, 255, 255), stroke_width=1, stroke_fill="black")
    draw_progress_bar(draw, 580, 432, 270, 15, data.get('fatigue', 0), (50, 50, 50), (100, 100, 255))

    # 2열
    draw.text((300, 472), "🚿 청결도", font=font_small, fill=(255, 255, 255), stroke_width=1, stroke_fill="black")
    draw_progress_bar(draw, 300, 497, 270, 15, data.get('cleanliness', 0), (50, 50, 50), (100, 255, 255))

    draw.text((580, 472), "💖 친밀도", font=font_small, fill=(255, 255, 255), stroke_width=1, stroke_fill="black")
